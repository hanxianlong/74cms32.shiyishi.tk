function allaround(templatedir,dir,jobslisturl,getkey,getarr)
{
	...
	opthtm+='</form>';
	opthtm+='</div>	';			
	opthtm+='<div class="keymore blue_l"><a href="'+href+'" id="advopen">显示更多条件</a></div>';
	...
	opthtm+='<li><span  id="talent-'+get[8]+'">'+name+'</span></li>';
	}
	opthtm+='</ul>';
	opthtm+='<div class="clear"></div>';
	opthtm+='</div>';
	...
	//显示已选
	getkey=getkey=='请输入：技能，特长，职位，学历，姓名，地区，学校等...'?'':getkey;
	...
	$("form[name=searcform]").submit( function () {
		...
		if ($("#key").val()=="请输入：技能，特长，职位，学历，姓名，地区，学校等...")
		{
			$("#key").val('');
		}
	});
