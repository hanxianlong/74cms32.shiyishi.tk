...
elseif($act == 'edit_category_save')
{
	...
	$setsqlarr['c_note']=trim($_POST['c_note']);		
        $setsqlarr['c_name_en']=!empty($_POST['c_name_en']) ?trim($_POST['c_name_en']) : adminmsg("请填写英文名称",1);
...
elseif($act == 'edit_district_save')
{
	...
	$setsqlarr['category_order']=intval($_POST['category_order']);
        	$setsqlarr['categoryname_en']=!empty($_POST['categoryname_en']) ?trim($_POST['categoryname_en']) : adminmsg("请填写英文名称",1);
